...
export const ALL_RECITERS: Reciter[] = [
  ...
  {
    id: 'ar.warsh.dosari',
    name: 'Ibrahim Al-Dosari (Warsh an Nafi)',
    arabicName: 'إبراهيم الدوسري (رواية ورش عن نافع)',
    category: 'warsh',
    style: 'Warsh',
    bitrate: '128kbps',
    country: 'Saudi Arabia',
...
const EVERYAYAH_RECITERS: Record<string, string> = {
  ...
  'ar.qasim': 'Muhsin_Al_Qasim_192kbps',
  ...
  'ar.bukhatir': 'Salaah_AbdulRahman_Bukhatir_128kbps',
  'ar.jibreel': 'Muhammad_Jibreel_128kbps',
  'ar.tunaiji': 'khalefa_al_tunaiji_64kbps',
  'ar.nabil': 'Nabil_Rifa3i_48kbps',
  'ar.sahl': 'Sahl_Yassin_128kbps',
  'ar.yasersalamah': 'Yaser_Salamah_128kbps',
  'ar.qahtani': 'Khaalid_Abdullaah_al-Qahtaanee_192kbps',
  'ar.matroud': 'Abdullah_Matroud_128kbps',
  'ar.basfar': 'Abdullah_Basfar_192kbps',
  'ar.warsh.abdulbasit': 'warsh/warsh_Abdul_Basit_128kbps',
  'ar.warsh.jazairi': 'warsh/warsh_yassin_al_jazaery_64kbps',
  'ar.warsh.dosari': 'warsh/warsh_ibrahim_aldosary_128kbps',
  'ar.abdelkareem': 'Muhammad_AbdulKareem_128kbps',
  'ar.alili': 'aziz_alili_128kbps',
  'ar.aymansowaid': 'Ayman_Sowaid_64kbps',
  // Fallbacks & Aliases
  'ar.baleela': 'MaherAlMuaiqly128kbps',
  'ar.abkar': 'Nasser_Alqatami_128kbps',
  'ar.jalil': 'Yasser_Ad-Dussary_128kbps',
  'ar.yamani': 'Alafasy_128kbps',
  'ar.kurdi': 'Fares_Abbad_64kbps',
  'ar.awsi': 'Saood_ash-Shuraym_128kbps',
  'ar.muhaisni': 'Muhammad_Ayyoub_128kbps',
  'ar.bahtimi': 'Mustafa_Ismail_48kbps',
  'ar.warsh.qazabri': 'warsh/warsh_Abdul_Basit_128kbps',
  'ar.qalun.dokali': 'warsh/warsh_yassin_al_jazaery_64kbps',
...
export async function fetchVerses(
  ...
  const catalogReciter = ALL_RECITERS.find((r) => r.id === safeReciterId)
  const everyAyahFolder =
    customReciter?.subfolder ||
    catalogReciter?.subfolder ||
